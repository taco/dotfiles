...
| **Just capture it**  | Create a single issue                                                           |
...
When writing a design doc, follow this format:
...
2. **Replace placeholder headings** with linked issue numbers: `### [#N](<issue-url>): Title`
